#!/usr/bin/env python3
"""Reopen the character-v9 PSD and compare its visible composite to PNG."""
...
PSD_PATH = ROOT / "assets/character-v9/exports/tsukuyomi-nemuri-faceless-poc-v9.psd"
EXPECTED_PATH = ROOT / "assets/character-v9/previews/live2d-neutral-v1.png"
OUTPUT_PATH = ROOT / "assets/character-v9/previews/psd-reopen-composite-v1.png"
...
def main() -> None:
    ...
    if not expected_layers.issubset(set(result["layer_names"])):
        raise SystemExit("PSD is missing one or more required v9 layers")
