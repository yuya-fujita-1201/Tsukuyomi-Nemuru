#!/usr/bin/env python3
"""Reopen the character-v8 PSD and compare its visible composite to PNG."""
...
PSD_PATH = ROOT / "assets/character-v8/exports/tsukuyomi-nemuri-faceless-poc-v8.psd"
EXPECTED_PATH = ROOT / "assets/character-v8/previews/live2d-neutral-v1.png"
OUTPUT_PATH = ROOT / "assets/character-v8/previews/psd-reopen-composite-v1.png"
...
def main() -> None:
    ...
    if not expected_layers.issubset(set(result["layer_names"])):
        raise SystemExit("PSD is missing one or more required v8 layers")
