#!/usr/bin/env python3
"""Reopen the character-v6 PSD and compare its visible composite to PNG."""
...
PSD_PATH = ROOT / "assets/character-v6/exports/tsukuyomi-nemuri-faceless-poc-v6.psd"
EXPECTED_PATH = ROOT / "assets/character-v6/previews/live2d-neutral-v1.png"
OUTPUT_PATH = ROOT / "assets/character-v6/previews/psd-reopen-composite-v1.png"
...
def main() -> None:
    ...
    # preview keeps transparent pixels. Compare the same visible RGB result.
